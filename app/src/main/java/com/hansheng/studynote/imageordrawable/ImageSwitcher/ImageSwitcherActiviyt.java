package com.hansheng.studynote.imageordrawable.ImageSwitcher;
...
public class ImageSwitcherActiviyt extends AppCompatActivity implements ViewSwitcher.ViewFactory, View.OnTouchListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imgIds = new int[]{R.drawable.ic_item01,R.drawable.ic_item02,R.drawable.ic_item03,R.drawable.ic_item04,
