package com.hansheng.studynote.ImageViewandDrawable.Imageloader.ui;
...
import com.hansheng.studynote.ImageViewandDrawable.Imageloader.ImageLoader;
import com.hansheng.studynote.ImageViewandDrawable.Imageloader.utils.MyUtils;

/**
 * Created by hansheng on 2016/6/27.
 */
public class GridImageActivity extends Activity implements OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        initView();
        mImageLoader = ImageLoader.build(GridImageActivity.this);
    }
