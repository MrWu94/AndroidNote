package com.hansheng.studynote.systemclean.textcounter;
...
import com.hansheng.studynote.systemclean.textcounter.formatters.CommaSeparatedDecimalFormatter;
import com.hansheng.studynote.systemclean.textcounter.formatters.DecimalFormatter;
import com.hansheng.studynote.systemclean.textcounter.formatters.IntegerFormatter;
import com.hansheng.studynote.systemclean.textcounter.formatters.NoFormatter;
...
public class CounterView extends TextView {
    ...
    protected void updateCounterType() {
        switch(counterType) {
            case NUMBER:
                formatter = (Formatter) new IntegerFormatter();
                break;
            case DECIMAL:
